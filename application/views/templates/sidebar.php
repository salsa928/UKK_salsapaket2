...
<div  id="wrapper">
  ...
  <!-- Sidebar -->
  <ul style="background: linear-gradient(to bottom, #cc99ff 0%, #ff99cc 100%);" class="navbar-nav  sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <li class="nav-item">
          ...
          <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              ...
              <a class="collapse-item" href="<?= base_url('master/admin'); ?>">Data Admin</a>
