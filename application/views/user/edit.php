                        ...
                        <div class="card-body">
                            <form action="<?= base_url('user/edit'); ?>" method="post">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-2">
                                        <a href="<?= base_url('user/edit_telp'); ?>" class="btn btn-primary btn-sm mt-1"><i class="fa fa-edit"></i> Edit No telp</a>
                                    </div>
                                </div>

                                <button type="submit" class="btn btn-info"><i class="fa fa-save"></i> Simpan</button>
                                <a href="<?= base_url('user/edit_password'); ?>" class="btn btn-primary"><i class="fa fa-key"></i> Edit Password</a>
                            </form>
                        </div>
                    </div>
                </div>
